 ...
 * Use the [AdminBookDetailFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AdminBookDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminBookDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminBookDetailFragment().apply {
